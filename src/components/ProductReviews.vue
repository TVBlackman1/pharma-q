  ...
  <div class="reviews">
    ...
    <div class="review-list">
      <div class="review">
        <div class="nick">
          <div class="icon"></div>
          <div class="name">Hasel1284</div>
        </div>
        <div class="category">
          <div class="name">Применялся для:</div>
          <div class="content">Профилактики ОРВИ </div>
        </div>
        <div class="category">
          <div class="name">Комментарий:</div>
          <div class="content">Препарат неплох, симптомы облегчает и быстрее выздоравливаю после него так что в принципе советую. мне хватает и упаковки на 10 таблеток не вижу смысла больше брать если на одного человека- за глаза.</div>
        </div>
        <div class="votes">голоса за/против</div>
      </div>
    </div>
  </div>
</template>
